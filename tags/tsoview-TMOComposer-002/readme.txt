...
注意：
・TSOView.exeと同じフォルダにtoonshader.cgfxが必要です。
...
　←キー：Y軸中心に左回転
　→キー：Y軸中心に右回転
　Page Upキー：Y軸中心に回転（アップ）
　Page Downキー：Y軸中心に回転（ダウン）
　Aキー：Z軸中心に左回転
　Dキー：Z軸中心に右回転
...
　0キー：カメラ位置を初期位置に戻す
　1キー：カメラ位置1を読み込む
　Crtl+1キー：カメラ位置1を保存 (camera1.xml)
　2キー：カメラ位置2を読み込む
　Crtl+2キー：カメラ位置2を保存 (camera2.xml)
　Cキー：カメラ位置1とカメラ位置2を補間・解除
　Gキー：shader設定画面を起動
