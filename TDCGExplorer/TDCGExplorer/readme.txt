...
セーブファイルビューアのコンテキストメニューに、TAHファイル生成を
追加しました。ヘビーセーブ、通常セーブからTAHファイルを生成します。
アイコンは暫定の物がつきますが、将来はTSOからレンダリングする様に
したいと思います。

07-17 beta2

TAHエディタ色番号の変更機能がつきました。zipからのみパーツを検索する
モードを追加しました。一部無駄なコードがあったのを整理しました。
セーブファイルからTAHファイルを作るとき、N999SAVEに色番号をつけて
無駄に名前空間を消費しないでTAHファイルを生成する事ができます。

07-17 beta3

zip優先だとお化けが出るバグを直しました.

07-17 beta4

zip中のセーブファイルを表示するとセーブファイルビューが表示されない
不具合を修正しました。
