...
namespace jp.nyatla.nymmd.cs.struct_type
{
    ...
    {
        public static void write(MmdColor4 i_dest, DataWriter i_writer)
        {
            i_writer.writeFloat(i_dest.r);
            i_writer.writeFloat(i_dest.g);
            i_writer.writeFloat(i_dest.b);
            i_writer.writeFloat(i_dest.a);
            return;
        }
        public static void write(MmdColor3 i_dest, DataWriter i_writer)
        {
            i_writer.writeFloat(i_dest.r);
            i_writer.writeFloat(i_dest.g);
            i_writer.writeFloat(i_dest.b);
