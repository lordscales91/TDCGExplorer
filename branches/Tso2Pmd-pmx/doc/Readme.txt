...
MikuMikuDanceのモデルデータ(.pmd)に、変換するツールです。
...
■ライセンス
Tso2Pmdは、NyMmdよりGPLv2を継承しています。
ただし、TSOView-0.3.1部分についてはその限りではありません。
